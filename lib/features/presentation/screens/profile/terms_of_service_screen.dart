      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              'Introduction',
              'Welcome to Shop Now. By accessing or using our mobile application, '
            ...
            _buildSection(
              'Definitions',
              '"App" refers to the Shop Now mobile application\n'
            ...
            _buildSection(
              'Intellectual Property',
              'All content, designs, and intellectual property in the App are owned by Shop Now. '
            ...
            _buildSection(
              'Limitation of Liability',
              'Shop Now is not liable for any indirect, incidental, or consequential damages '
